...
class OpenAIServiceTests(unittest.IsolatedAsyncioTestCase):
    ...
    def test_o7digital_profile_supports_all_site_languages_and_domains(self):
        ...
        self.assertEqual(profile.name, "o7Digital")
        ...
        self.assertEqual(profile.integrations["leads"], "o7-pulse")
        self.assertEqual(
            profile.integrations["notificationEmail"],
            "info@o7digitalgroup.com",
        )
        self.assertIn("info@o7digitalgroup.com", profile.knowledge)

...
![Inbox Jean Louis David](jld-guide-assets/01-inbox-jld.png)
...
![Automatizaciones](jld-guide-assets/02-automatizaciones.png)
...
![Clientes](jld-guide-assets/03-clientes.png)

La sección **Clients** permite encontrar visitantes, datos de contacto y estado de atención.

## 4. Estadísticas

![Estadísticas](jld-guide-assets/04-estadisticas.png)
...
![Copiloto IA](jld-guide-assets/05-copiloto.png)
...
![Configuración](jld-guide-assets/06-configuracion.png)
